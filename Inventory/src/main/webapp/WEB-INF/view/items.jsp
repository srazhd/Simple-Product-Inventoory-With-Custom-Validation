...
<body>
	...
	<div class="col-md-12" style="float: left;">
		...
		<table class="table table-bordered ">
			<tr>
				...
				<td>Action</td>
					...
					<c:forEach var="b" items="${itemList}">
					    <tr>
					      <td>${b.id}</td>
					      <td>${b.name}</td>
					      <td>${b.brand.name}</td>
					      ...
					      <td>${b.entryDate}</td>
					      <td>
					      <a href="/Inventory/items/edit/${b.id}" class="btn btn-warning">EDIT</a>
					      <a href="/Inventory/items/delete/${b.id}" onclick="return confirm('Are You Sure To Delete The Selected Model?')" class="btn btn-danger">DELETE</a>
		...
		<div class="col-md-12" style=" float:left; margin-top: 10px; margin-bottom: 10px;">
			<a href="/Inventory/items/addItems" class="btn btn-primary">Add New Item </a>
		</div>
		</div>
