...
<body>
	...
	<div class="col-md-10" style="float: left;">
				...
				<td>Action</td>
					...
					<c:forEach var="b" items="${brandList}">
					    <tr>
					      ...
					      <td>${b.entryDate}</td>
					      <td>
					      <a href="/Inventory/brand/edit/${b.id}" class="btn btn-warning">EDIT</a>
					      <a href="/Inventory/brand/delete/${b.id}" onclick="return confirm('Are You Sure To Delete The Selected Brand?')" class="btn btn-danger">DELETE</a>
		...
		<div class="col-md-12" style=" float:left; margin-top: 10px; margin-bottom: 10px;">
			<a href="/Inventory/brand/addBrand/" class="btn btn-primary">Add New Brand </a>
		</div>
		</div>
